...
{
public:
    AllocationBlock(std::uint32_t block_id, std::uint8_t numa_node_id, std::size_t size);
...
private:
    ...
    [[nodiscard]] std::optional<std::pair<std::size_t, std::size_t>> find_block(std::size_t alignment,
